        ...
        <div id="content" class="p-4 p-md-5">
            ...
            <form action="cliente-editar" method="POST">
                <fieldset>
                    ...
                    <?php $_SESSION['id_cliente'] = $dados[0]['id_cliente'] ?? '';?>
                    ...
                    <label>CPF<br><input type="text" name="cpf" value="<?= $dados[0]['cpf'] ??''; ?>" placeholder="000.000.000-00" required></label><br>
              ...
              <label>CEP<br><input type="number" name="cep" value="<?= $dados[0]['cep'] ??''; ?>" placeholder="00000-000" required></label><br>
              <label>Rua<br><input type="text" name="rua" value="<?= $dados[0]['rua'] ??''; ?>" required></label><br>
              <label>Número<br><input type="number" name="numEndereco"value="<?= $dados[0]['numero'] ??''; ?>"  required></label><br>
              <label>Bairro<br><input type="text" name="bairro" value="<?= $dados[0]['bairro'] ??''; ?>" required></label><br>
              <label>Cidade<br><input type="text" name="cidade" value="<?= $dados[0]['cidade'] ??''; ?>" required></label><br>
